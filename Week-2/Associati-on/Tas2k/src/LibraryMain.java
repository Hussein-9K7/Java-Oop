...
// يتم إنشاء كائني "كتاب" و"مكتبة" مع وظائف لإضافة الكتب، عرضها، استعارتها، وإرجاعها.
// فئة Book تحتوي على بيانات الكتاب مثل العنوان، المؤلف، وسنة النشر.
// فئة Library تحتوي على قائمة من الكتب مع وظائف لإدارتها.
// الفئة الرئيسية LibraryMain تقوم بإنشاء الكتب وإضافتها إلى المكتبة وعرضها واستعارتها وإرجاعها.
